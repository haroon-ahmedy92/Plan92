...
object MockPlannerRepository {
    ...
    val templates = listOf(
        ...
        PlannerTemplate("grid_page", "Grid Page", "notes", "A flexible square-grid writing page", PlannerFamily.NOTES_PAGE, AzureDepth, Amethyst, PlannerLayoutKind.MeetingNotes),
        PlannerTemplate("dot_grid_page", "Dot Grid Page", "notes", "A dot-grid page for sketches, notes, and planning", PlannerFamily.NOTES_PAGE, RoyalIndigo, ApricotGlow, PlannerLayoutKind.MeetingNotes),
        ...
        PlannerTemplate("weekly_projects", "Weekly Projects Work Journal", "weekly", "Weekly work goals, activities, and challenges", PlannerFamily.WEEKLY_PLANNER, AzureDepth, MintAccent, PlannerLayoutKind.WeeklyPlanner),
        ...
        PlannerTemplate("yearly_planner", "2026 Yearly Planner", "yearly", "Goals and yearly overview", PlannerFamily.YEARLY_PLANNER, MintAccent, AzureDepth, PlannerLayoutKind.YearlyPlanner),
        ...
        PlannerTemplate("office_organizer", "Office Organizer Planner", "work", "Goals, calls, emails, meetings, and schedule", PlannerFamily.WORK_PLANNER, RoyalIndigo, BurntOrange, PlannerLayoutKind.WorkPlanner),
        ...
        PlannerTemplate("project_planner", "Project Planner", "work", "Objective, resources, brainstorm, and progress", PlannerFamily.PROJECT_PLANNER, AzureDepth, ApricotGlow, PlannerLayoutKind.ProjectOverview),
        ...
        PlannerTemplate("mom_planner", "Mom Planner", "versatile", "Family, meals, habits, savings, and routines", PlannerFamily.FAMILY_ORGANIZER, ApricotGlow, BurntOrange, PlannerLayoutKind.FamilyOrganizer),
        PlannerTemplate("mom_chores", "Mom Chores Planner", "versatile", "Day-by-day chores with must-do and extra time tasks", PlannerFamily.FAMILY_ORGANIZER, OrchidBurst, ApricotGlow, PlannerLayoutKind.FamilyOrganizer),
        PlannerTemplate("class_schedule", "Class Schedule", "student", "Weekly class timetable", PlannerFamily.STUDENT_PLANNER, AzureDepth, RoseAccent, PlannerLayoutKind.StudentPlanner),
        ...
        PlannerTemplate("medical_notes", "Medical Notes", "notes", "Symptoms, medications, and visit notes", PlannerFamily.NOTES_PAGE, BrickRed, ApricotGlow, PlannerLayoutKind.MeetingNotes),
        PlannerTemplate("nurse_planner", "Nurse Planner", "work", "Shift planning, patients, and medication tasks", PlannerFamily.WORK_PLANNER, AzureDepth, OrchidBurst, PlannerLayoutKind.WorkPlanner),
        PlannerTemplate("doctor_list", "Doctors List Planner", "notes", "Contacts, specialties, and appointments", PlannerFamily.APPOINTMENT_PLANNER, RoyalIndigo, ApricotGlow, PlannerLayoutKind.AppointmentPlanner),
        PlannerTemplate("event_planner", "Event Planner", "versatile", "Event overview, vendors, checklist, and timeline", PlannerFamily.PROJECT_PLANNER, BurntOrange, OrchidBurst, PlannerLayoutKind.ProjectOverview),
        PlannerTemplate("monthly_bill", "Monthly Bill Payment Tracker", "budget", "Track due dates, paid dates, and balances", PlannerFamily.BUDGET_PLANNER, RoyalIndigo, BurntOrange, PlannerLayoutKind.BudgetOverview),

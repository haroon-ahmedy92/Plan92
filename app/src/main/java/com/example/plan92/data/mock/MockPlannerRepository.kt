...
object MockPlannerRepository {
    ...
    val templates = listOf(
        ...
        PlannerTemplate("grocery", "Grocery Checklist", "todo", "Essentials and pantry", PlannerFamily.GROCERY_PLANNER, AzureDepth, BurntOrange, PlannerLayoutKind.GroceryPlanner),
        ...
        PlannerTemplate("meal", "Meal Planner", "selfcare", "Weekly menu and prep", PlannerFamily.MEAL_PLANNER, ApricotGlow, AzureDepth, PlannerLayoutKind.MealPlanner),
        ...
        PlannerTemplate("adhd", "ADHD Planner", "adhd", "Focus and support blocks", PlannerFamily.ADHD_DAILY_PLANNER, Amethyst, BurntOrange, PlannerLayoutKind.AdhdPlanner),
        PlannerTemplate("bullet_weekly", "Bullet Journal", "bullet", "Weekly bullet layout", PlannerFamily.BULLET_JOURNAL, RoyalIndigo, OrchidBurst, PlannerLayoutKind.BulletJournal),
        PlannerTemplate("meeting", "Meeting Notes", "notes", "Agenda and next steps", PlannerFamily.MEETING_NOTES, AzureDepth, ApricotGlow, PlannerLayoutKind.MeetingNotes),
